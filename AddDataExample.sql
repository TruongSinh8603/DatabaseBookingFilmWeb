...
insert into PhongChieu(TenPC, SoHangGhe, SoGheMoiHang, MaRC)
values
(N'QuangTrung1', 10, 10, 1),
(N'QuangTrung2', 12, 11, 1),
(N'QuangTrung3', 10, 8, 1),
(N'QuangTrung4', 8,10, 1),
(N'QuangTrung5', 11,11, 1),
(N'NguyenTrai1', 11, 10, 2),
(N'NguyenTrai2', 7,10, 2),
(N'NguyenTrai3', 7,10, 2),
(N'HaiBaTrung1', 5,10, 3),
(N'HaiBaTrung2', 5,10, 3);

insert into LichChieu(NgayChieu, SuatChieu, MaPhim, MaPC)
values
	('2024-04-11', '10:00:00', 1, 1),
    ('2024-04-11', '13:00:00', 2, 2),
    ('2024-04-12', '14:00:00', 9, 3),
    ('2024-04-12', '17:00:00', 3, 4),
    ('2024-04-13', '19:00:00', 10, 5),
    ('2024-04-14', '21:00:00', 4, 1),
    ('2024-04-14', '12:00:00', 5, 2),
    ('2024-04-15', '15:00:00', 6, 4),
    ('2024-04-15', '18:00:00', 7, 3),
    ('2024-04-16', '20:00:00', 8, 4);
...
VALUES 
('BAPPHOMAI', N'Bắp Phô Mai', 75000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616241/yqhqjji6bsvkvxyj9dbb.jpg'),
('BAPTHUONG', N'Bắp Ngọt', 60000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616241/vikr4syow0jktflc921w.jpg'),
('COMBOBAP2LOAI', N'Combo bắp phô mai và ngọt', 120000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616239/r5iuvt6s9oztecgzg6hl.jpg'),
('COMBOBAPNUOC', N'Combo bắp thường và nước bất kỳ', 75000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616240/a3q272a0zbvvzt2xckhq.jpg'),
('NUOCCOCA', N'Nước Coca', 20000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616239/bqnkvllnidxnpvcnyd1r.jpg'),
('NUOCMIRINDA', N'Nước Mirinda', 20000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713616240/ugh6du0imiw08isw9ofv.jpg'),
('testmai', N'test', 111000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713635465/Screenshot_2023-09-05_201317_llhqyj.png'),
('testtachFunction', N'test', 111111000, 'https://res.cloudinary.com/dzamheemx/image/upload/v1713636283/Screenshot_2023-09-25_092635_fr5vlt.png');
